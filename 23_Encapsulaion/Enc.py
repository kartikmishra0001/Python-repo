# Encapsulation :- 
# Encapsulation is about protecting data insida a class. 
# It means keeping data(properties) and methods together in a class, while controlling how the data can ne accessed from outside the class. 
# This prevents accidental changes to your data and hides the internal details o how your class works. 
...
# The setter method can also validate the value befor setting it:
class Person:
    def __init__(self, name, age):
        self.name = name
        self.__age = age
...
# > Flexibility: Internal implementation can change without affection external code
...
# Python also has a convertion for protected properties using a single underscore _ prefix:
class Person:
    def __init__(self, name, salary):
        self.name = name
        self._salary = salary # Protected property

p1 = Person("Linus", 3000)
print(p1.name)
