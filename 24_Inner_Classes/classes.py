# Inner Classes :-
# An inner class is a class defined inside class. The inner class can access the properties and methods of the outer class. 

# Inner classes are useful for grouping classes that are only used in one place, makeing your code more orgainzed. 
class Outer:
    def __init__(self):
